...
- [x] **T001** [P]: Crear `src/app/domains/wells/models/well-name-preview.dto.ts`
...
- [x] **T002** [P]: Modificar `src/app/core/http/api-endpoints.ts`
  - Agregar `previewName: \`\${hosts.gopApi}/api/v1/wells/preview-name\`` dentro de `API.wells`

- [x] **T003**: Modificar `src/app/domains/wells/models/index.ts`
...
- [x] **T004**: Modificar `src/app/domains/wells/services/wells-api.service.ts`
...
- [x] **T005**: Modificar `src/app/domains/wells/mocks/wells.mock-handlers.ts`
...
- [x] **T006**: Modificar `src/app/domains/wells/features/well-form/locale.ts`
...
- [x] **T007** [P]: Crear `src/app/domains/wells/features/well-form/components/well-name-preview/well-name-preview.component.ts`
...
- [x] **T008** [P]: Crear `src/app/domains/wells/features/well-form/components/well-name-preview/well-name-preview.component.html`
...
- [x] **T009** [P]: Crear `src/app/domains/wells/features/well-form/components/step-contract-info/step-contract-info.component.ts`
...
- [x] **T010** [P]: Crear `src/app/domains/wells/features/well-form/components/step-contract-info/step-contract-info.component.html`
...
- [x] **T011** [P]: Crear `src/app/domains/wells/features/well-form/components/step-technical-data/step-technical-data.component.ts`
  - Componente Dumb standalone con `OnPush`
  - Inputs: `formGroup`, opciones de los 5 dropdowns técnicos, `locale`
  - Sin outputs

- [x] **T012** [P]: Crear `src/app/domains/wells/features/well-form/components/step-technical-data/step-technical-data.component.html`
  - Grid de 5 dropdowns: tipoTrayectoria, tipoUbicación, tipoÁngulo, tipoObjetivo, tipoTerminación
  - Mensajes de error por campo

- [x] **T013** [P]: Crear `src/app/domains/wells/features/well-form/components/step-location/step-location.component.ts`
  - Componente Dumb standalone con `OnPush`
  - Inputs: `formGroup`, `departamentos`, `municipios`, `locale`
  - Outputs: `departamentoChanged`

- [x] **T014** [P]: Crear `src/app/domains/wells/features/well-form/components/step-location/step-location.component.html`
  - Grid: departamento (p-select), municipio (p-select)
  - Mensajes de error por campo

- [x] **T015** [P]: Crear `src/app/domains/wells/features/well-form/components/step-summary/step-summary.component.ts`
  - Componente Dumb standalone con `OnPush`
...
- [x] **T016** [P]: Crear `src/app/domains/wells/features/well-form/components/step-summary/step-summary.component.html`
...
- [x] **T017**: Modificar `src/app/domains/wells/features/well-form/well-form.component.ts`
...
- [x] **T018**: Modificar `src/app/domains/wells/features/well-form/well-form.component.html`
...
| ID | Archivo | Tipo | Bloque | Paralelo | Estado |
|---|---|---|---|---|---|
...
**Total: 18 tareas atómicas en 4 bloques compilables. COMPLETADO ✅**
