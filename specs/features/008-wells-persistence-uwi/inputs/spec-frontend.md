...
**Then** se muestra la pregunta "¿El pozo va a llevar el nombre del campo?" (S�M/NO). Si S�M, se precarga el nombre del campo como prefijo y el usuario solo ingresa consecutivo. Si NO, se habilita denominación libre (RN-20).
